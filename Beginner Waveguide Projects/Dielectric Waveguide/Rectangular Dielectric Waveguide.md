...
\end{cases}$$
At the boundary the $E$-fields are continuous. So $E_{clad,z}(y=\frac{d}{2})=E_{core,z}(y=\frac{d}{2})$ $$-\frac{\alpha}{\epsilon_{clad}}Ce^{-\alpha\frac{d}{2}}=-\frac{k_y}{\epsilon_{core}}B\sin(k_yy)$$
