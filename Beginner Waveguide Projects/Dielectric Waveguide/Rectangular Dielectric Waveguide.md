...
\end{cases}$$
At the boundary the $E$-fields are continuous. So $E_{clad,z}(y=\frac{d}{2})=E_{core,z}(y=\frac{d}{2})$ $$\frac{\alpha}{\epsilon_{clad}}Ce^{-\alpha\frac{d}{2}}=\frac{k_y}{\epsilon_{core}}A\sin(k_y \frac{d}{2}) \qquad...(9)$$
$-A\sin(k_y y)$ is the even mode because recall that the first derivative of $H_x$ was taken. The amplitudes can be eliminated by the boundary condition $H_{clad,x}(y=\frac{d}{2}) = H_{core,x}(y=\frac{d}{2})$. $$Ce^{-\alpha\frac{d}{2}}=A\cos(k_y\frac{d}{2}) \qquad...(10)$$
Dividing $(9)$ by $(10)$ will result in $$$$
