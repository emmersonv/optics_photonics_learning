...
$-A\sin(k_y y)$ is the even mode because recall that the first derivative of $H_x$ was taken. The amplitudes can be eliminated by the boundary condition $H_{clad,x}(y=\frac{d}{2}) = H_{core,x}(y=\frac{d}{2})$. $$Ce^{-\alpha\frac{d}{2}}=A\cos\left(k_y\frac{d}{2}) \qquad...(10)$$
Dividing $(9)$ by $(10)$ will result in $$\frac{\alpha}{\epsilon_{clad}}=\frac{k_y}{\epsilon_{core}}\tan()$$
