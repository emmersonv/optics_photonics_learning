...
The problem at hand is how can the coupling coefficient $\kappa$ be controlled? The integral in $(1)$ will be solved first. $u_1(y)$ is the field in core 1 from waveguide 1. Assuming a 