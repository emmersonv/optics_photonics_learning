...
The solution of this differential equation will yield the optical powers in waveguides 1 and 2 if th:$$P_1(z)=P_1(0)\left[\cos^2(\gamma z) + \left(\frac{\Delta \beta}{2\gamma}\right)^2 \sin^2(\gamma z)\right]$$
