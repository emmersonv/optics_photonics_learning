...
**Plot the cross-over length $\frac{\pi}{4\kappa}$ over different gaps to numerically obtain the coupling coefficient $\kappa$.... oh my god its just like a classic physics lab**